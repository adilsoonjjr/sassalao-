          ...
          {filtered.map((ag) => (
            ...
            >
              ...
              <div className="flex gap-2 pt-2 border-t" style={{ borderColor: "var(--border)" }}>
                ...
                <Link
                  href={`/agendamentos/novo?clienteNome=${encodeURIComponent(ag.clienteNome)}&clienteTel=${encodeURIComponent(ag.clienteTel ?? "")}`}
                  className="py-2 px-3 rounded-xl text-xs font-semibold flex items-center gap-1 transition-opacity hover:opacity-80 active:opacity-70"
                  style={{ background: "var(--accent)", color: "var(--primary-dark)" }}
                  title="Remarcar este cliente"
                >
