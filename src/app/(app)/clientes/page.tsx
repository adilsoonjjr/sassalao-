        ...
        {filtrados.map(c => (
          <div key={c.id} className="rounded-2xl p-4 flex items-center gap-3"
            ...
            <div className="flex gap-2 flex-shrink-0">
              ...
              <Link
                href={`/agendamentos/novo?clienteNome=${encodeURIComponent(c.nome)}&clienteTel=${encodeURIComponent(c.telefone)}`}
                className="w-9 h-9 rounded-xl flex items-center justify-center transition-opacity hover:opacity-75"
                style={{ background: "var(--accent)" }} title="Agendar">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--primary-dark)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01"/></svg>
              </Link>
